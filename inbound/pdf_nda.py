...
NDA_CHOICE_FIELDS = [
    ("govt_affiliation", 265, 403, 342, 414, ["Choose an item", "Yes", "No"]),
    ("will_manage", 167, 525, 250, 537, 
        ["Choose an item", 
        "Remotely/semi-actively", 
        "1 day/wk", 
        "2days/wk", 
        "3days/wk", 
        "4days/wk", 
        ...
        "6days/wk", 
        "7days/wk"]),
    ("other_deciders", 115, 539, 177, 550, ["Choose an item",
                                            "Wife/Bus Partner",
                                            "Relative",
                                            "Friend",
                                            "Child",
                                            ...
                                            "Angel Investor",
                                            "Hard money lender"]),
    ("industry_experience", 168, 561, 250, 573, ["Choose an item",
                                                "Yes",
                                                "No",
                                                "Maybe"]),
    ("timeframe", 480, 561, 553, 573, ["Choose an item",
                                        "1 Month",
                                        "2 Months",
                                        "3 Months",
                                        "4 Months",
                                        ...
                                        "11 Months",
                                        "12 Months"]),
    ("liquid_assets", 203, 599, 340, 611, ["Choose an item", 
                                            "$50,000",
                                            "$50,001-$150,000",
                                            "$150,001-$250,000",
                                            "$250,001-$350,000",
                                            ...
                                            "$3,050,001-$3,550,000",
                                            "$3,550,001-$4,050,000"]),
    ("real_estate", 443, 599, 520, 611, ["Choose an item", 
                                            "$50,000",
                                            "$50,001-$150,000",
                                            "$150,001-$250,000",
                                            "$250,001-$350,000",
                                            ...
                                            "$3,050,001-$3,550,000",
                                            "$3,550,001-$4,050,000"]),
    ("retirement_401k", 182, 616, 340, 628, ["Choose an item", 
                                            "$50,000",
                                            "$50,001-$150,000",
                                            "$150,001-$250,000",
                                            "$250,001-$350,000",
                                            ...
                                            "$3,050,001-$3,550,000",
                                            "$3,550,001-$4,050,000"]),
    ("funds_for_business", 500, 616, 593, 628, ["Choose an item", 
                                            "$50,000",
                                            "$50,001-$150,000",
                                            "$150,001-$250,000",
                                            "$250,001-$350,000",
                                            ...
                                            "$3,050,001-$3,550,000",
                                            "$3,550,001-$4,050,000"]),
    ("using", 358, 631, 458, 645, ["Choose an item",
                                    "Own Cash",
                                    "Bank Cash",
                                    "401K",
                                    "Partner Funds"]),
